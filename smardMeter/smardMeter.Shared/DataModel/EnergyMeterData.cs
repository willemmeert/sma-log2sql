...
{
    using EnergyMeterDataDictionary = SCG.Dictionary<short, long>;     // definition of our "Map": key = address * 10 + type (4 or 8, for actual or sum)
    ...
    public static class Extension
    {
        ...
        public static int RemoveAll<T>(this SCG.LinkedList<T> list, Predicate<T> match)
        {
            if (list == null)
            {
